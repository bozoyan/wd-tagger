...
<body class="min-h-screen transition-colors duration-300">
            ...
            <div class="lg:col-span-2">
                ...
                <div class="card p-6 shadow-xl glow-effect">
                    ...
                    <form id="uploadForm" enctype="multipart/form-data">
                        ...
                        <input type="file" name="images[]" id="batchInput" class="hidden" multiple accept="image/*">
                    </form>
    ...
    <script>
        ...
        batchInput.addEventListener('change', (e) => {
            console.log('文件选择框change事件触发');
            console.log('选择的文件数量:', e.target.files.length);
            console.log('选择的文件列表:', e.target.files);
        ...
        batchDropArea.addEventListener('drop', (e) => {
            ...
            console.log('拖拽文件列表:', e.dataTransfer.files);
        ...
        function displayBatchFiles() {
            console.log('显示文件列表，文件数量:', selectedFiles.length);
            fileListContainer.innerHTML = '';
            let totalFileSize = 0;
        ...
        batchProcessBtn.addEventListener('click', async () => {
            console.log('开始批量处理，选中的文件数量:', selectedFiles.length);
            console.log('选中的文件:', selectedFiles);
            ...
            console.log('选中的标签类型:', selectedTagTypes);
            ...
            for (let pair of formData.entries()) {
                console.log('FormData条目:', pair[0], pair[1]);
            }
            ...
            batchProgressText.textContent = `正在处理第 0 张图片，共 ${selectedFiles.length} 张`;
